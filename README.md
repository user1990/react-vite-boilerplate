# vite-react-ts-tailwind-MUI-starter

Starter using Vite + React + TypeScript + Tailwind + Material UI + React Query.
...
## Formatter, Linter & Husky

Already set up [ESLint](https://eslint.org/), [Prettier](https://prettier.io/) & [Husky](https://github.com/typicode/husky).
